...
'''X_im = np.load("D:\\All of my life\\All after Graduated\\VISTEC\\BCI Work\\[SSVEP]\\Vrep_Interfacing\\Dataset_10_subjs_60secs_5conds_filrange6and25Hz.npy")[1:,:,:]
X_im_add = np.load("D:\\All of my life\\All after Graduated\\VISTEC\\BCI Work\\[SSVEP]\\Vrep_Interfacing\\Dataset_Additional_6_subjs_60secs_5conds_filrange6and25Hz.npy")[1:,:,:]
...
# In[5]:
smp_freq = 512  # 250 Hz
win_len = 1 # 3s  Using sliding window size 3 secs

# condition = 1       #1-4 ignore con0
PI = np.pi
sampling_frequency = 512
candidate_frequency = [5.45, 7.5, 10, 12]
...
PASSBAND_RIPPLE = 0.5 #0.5 is default
padding_frequency = 2
num_subband = 8
# from paper
